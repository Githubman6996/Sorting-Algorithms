...
export class Sorter {
    ...
    rendered = 0;
    constructor() {
        this.thread = new Worker("./src/threadWasm.js");
    ...
    frame() {
            ...
            let message, highlights = this.framesPerFrame,
                _;
...
Estimated Sorting Time: ${Sorter.formatFloat(Math.max(this.cur - this.startedAt, 0), 1, 2)}ms
