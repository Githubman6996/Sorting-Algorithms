...
export class Renderer {
    ...
    async load() {
        ...
        try {
            vertexShader = await this.compileShader("src/shaders/vertex.glsl", gl.VERTEX_SHADER);
            fragmentShader = await this.compileShader("src/shaders/fragment.glsl", gl.FRAGMENT_SHADER);
        } catch (e) {
            console.error(e);
        }
